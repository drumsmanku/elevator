document.addEventListener('DOMContentLoaded', () => {
    ...
    let moving; // Flag to check if the elevator is currently moving
  
    const FLOOR_HEIGHT = window.innerHeight / 3; // Assuming 3 floors
    const SPEED = 5000; // Time in ms to travel between floors
    ...
    function processNextFloor() {
      ...
      moveElevatorTo(nextFloor * FLOOR_HEIGHT, () => {
        ...
        }, 500); // Add a delay to allow the UI to update before processing the next floor
      });
    }
