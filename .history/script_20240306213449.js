document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('up0').addEventListener('click', () => {
        document.getElementById('up0').classList.add('pressed');
        addToQueue(1);
    });
    document.getElementById('up1').addEventListener('click', () => {
        document.getElementById('up1').classList.add('pressed');
        addToQueue(2);
    });
    document.getElementById('down1').addEventListener('click', () => {
        document.getElementById('down1').classList.add('pressed');
        addToQueue(0);
    });
    document.getElementById('down2').addEventListener('click', () => {
        document.getElementById('down2').classList.add('pressed');
        addToQueue(1);
    });
