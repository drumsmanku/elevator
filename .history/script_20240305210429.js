let currentFloor = 0; // 0 represents Ground, 1 represents Level 1, 2 represents Level 2
...
function animateElevator(destinationFloor, time) {
    ...
    door.style.transform = `translateY(${destinationFloor * 120}px)`; // Adjust as needed
    setTimeout(() => {
