document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('up1').addEventListener('click', () => {stopAtOneWhileGoingUp(); test1();});
    document.getElementById('down1').addEventListener('click', () => stopAtOneWhileComingDown());
