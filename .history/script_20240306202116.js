document.addEventListener('DOMContentLoaded', () => {
    ...
    function processNextFloor() {
        ...
        if ((currentFloor === 0 && nextFloor === 1 && !requestedFloors.some(request => request.floor === 1 && request.direction === 'up')) ||
            (currentFloor === 2 && nextFloor === 1 && !requestedFloors.some(request => request.floor === 1 && request.direction === 'down'))) {
            // Skip the floor
            console.log(`Skipping floor 1`);
